...
class Solution {
    // A pointer to store the previous node in the inorder traversal
    Node prev = null;
    
    // Function to convert binary tree to doubly linked list and return it.
    Node bToDLL(Node root) {
        // Initialize the head of the DLL as null
        Node head = null;
    ...
    Node convertToDLL(Node root, Node head) {
        ...
        if (prev == null) {
            // If prev is null, it means this node is the leftmost node
            // Hence, this node will be the head of the DLL
            head = root;
        } else {
            // Else, link the previous node with the current node
            root.left = prev;
            prev.right = root;
        }
